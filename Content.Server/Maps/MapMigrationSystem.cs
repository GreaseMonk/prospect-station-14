...
public sealed class MapMigrationSystem : EntitySystem
{
    ...
    private static readonly string[] MigrationFiles = { "/migration.yml", "/_NF/migration.yml", "/_PS/migration.yml" }; // Frontier: use array of migration files  // PS: added _PS/migration.yml
