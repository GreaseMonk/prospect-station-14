...
namespace Content.Shared.CCVar
{
    ...
    public sealed class CCVars : CVars
    {
        ...
        public static readonly CVarDef<string>
            GameLobbyDefaultPreset = CVarDef.Create("game.defaultpreset", "prospect", CVar.ARCHIVE); // Prospect
        ...
        /// </summary>
        public static readonly CVarDef<string>
            GameMap = CVarDef.Create("game.map", "ProspectSector", CVar.SERVERONLY); // Prospect
